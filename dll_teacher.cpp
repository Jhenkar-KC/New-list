...
int main()
{
    ...
    do
    {
        printf(" \n 1. Create a linked Teacher double linked list \n 2. Display linked Teacher double linked list list \n 3. Insert a Teacher double linked list node at last \n 4. Insert a Teacher double linked list node at front \n 5. Delete a Teacher double linked list node at last\n 6. Delete a Teacher double linked list node at first \n 7.Exit \n");
        printf("\nEnter your choice \n");
        scanf("%d", &choice);
        switch (choice)
        {
